...
public class FragmentNearby extends Fragment {
	...
	private NearbyGuideAdapter adapter;
	...
	private void getGuideNearby() {
		ServerCore.instance().getGuideNearby(handler, currentFetchOffset);
	}

	private void appendToListView() {
		adapter = new NearbyGuideAdapter(getActivity(),R.layout.card_my_guide, guides);
