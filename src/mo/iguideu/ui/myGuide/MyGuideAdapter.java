...
public class MyGuideAdapter extends ArrayAdapter<MyGuide> {

	public MyGuideAdapter(Context context, int textViewResourceId) {
	    super(context, textViewResourceId);
	}

	public MyGuideAdapter(Context context, int resource, List<MyGuide> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    viewHolder.tvLocation.setText(getItem(position).getMeetLocation().getCountryName()+","+
